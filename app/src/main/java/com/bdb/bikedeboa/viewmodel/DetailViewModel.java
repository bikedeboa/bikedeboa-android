...
public class DetailViewModel extends BaseObservable implements
	...
	public Drawable getRestrictionImage() {
		return AssetHelper.getRestrictionImage(rack.isPublic());
	}
